...
# 封装新增方法-宾馆场所基本信息
class PageModifyHotelBasicInfo(Base):
    # 点击数据信息菜单进入二级菜单
    ...
    # 一 基础情况
    def page_modify_basic(self, place, address, opentime, roomarea, roomnum, flow, staffs, staff_one_year, decro_time):
        place = self.base_input(page.place_name, place)

        self.base_click(page.hotel_type03)
    ...
    def page_modify_healty(self, bill_no, healthy_check):
        ...
        self.base_click(page.disease_staff_no)
        self.base_click(page.epidemic_solution_no)
        self.base_click(page.monitor_system_no)
        self.base_click(page.disease_control_no)
        self.base_click(page.disinfect_no)
        self.base_click(page.facility_run_no)
        self.base_click(page.quarantine_area_no)
    ...
    def page_modify_disinfectants(self, but_clean_t, but_clean_h, handr_clean_t, handr_clean_h, door_clean_t,
        ...
        self.base_click(page.disinfect_room_no)
    ...
    # 五、常态化情景下环境卫生状况
    def page_modify_environment(self, clean_t):
        ...
        self.base_click(page.trash_dispose_no)

        self.base_click(page.clean_day_no)

        self.base_click(page.water_seal_no)

        self.base_click(page.floor_drain_no)

        # self.base_input(page.clean_times, clean_t)

    # 表尾
    def page_modify_tail(self, investigate, review, input_date):
